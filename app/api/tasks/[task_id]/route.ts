...
export async function GET(req: Request, context: { params: { task_id: string } }) {
    try {
...
export async function DELETE(req: Request, context: { params: { task_id: string } }) {
    try {
        const h = await headers();
        const session = await auth.api.getSession({ headers: h });
...
export async function PATCH(req: Request, context: { params: { task_id: string } }) {
    try {
        const h = await headers();
        const session = await auth.api.getSession({ headers: h });
